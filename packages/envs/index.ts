export const envs = {
  ...
  ELEVATION_API_KEY: process.env.ELEVATION_API_KEY as string,
  ELEVATION_API_URL: process.env.ELEVATION_API_URL as string,
  SATELLITE_TRACKING_API_URL: process.env.SATELLITE_TRACKING_API_URL as string,
  SATELLITE_TRACKING_API_KEY: process.env.SATELLITE_TRACKING_API_KEY as string,
  SATELLITE_DATA_API_URL: process.env.SATELLITE_DATA_API_URL as string,
