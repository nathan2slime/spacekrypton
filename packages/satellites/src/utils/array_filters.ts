...
export const get_ground_vertex_positions_array = (model: THREE.Mesh | any) => {
...
export const get_ground_vertex_normals_array = (model: THREE.Mesh | any) => {
...
export const get_ground_vertex_colors_array = (model: THREE.Mesh | any) => {
...
export const get_vertex_from_array = (vertex: number[]): number[][] => {
  let result: number[][] = [];
